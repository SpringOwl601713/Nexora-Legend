...
contextBridge.exposeInMainWorld('nexora', {
  ...
  exportMatchScene:(scene:MatchScene,payload:unknown={})=>ipcRenderer.invoke('match:export',scene,payload),
  exportWholeMatchPack:(payload:unknown={})=>ipcRenderer.invoke('match:exportPack',payload),
  saveMatchPresetSnapshot:(payload:unknown={})=>ipcRenderer.invoke('match:savePresetSnapshot',payload),
  stopMatchScene:()=>ipcRenderer.invoke('match:stop'),
